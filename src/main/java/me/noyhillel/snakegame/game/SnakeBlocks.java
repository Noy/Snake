...
public final class SnakeBlocks {
     ...
     * It's a lot easier to create data classes like this using lombok because we can actually determine that this is a data class instead of having border plate code
     * E.g.
     *
